...
//	template: 'hr_dashboard.dashboard',
	events: _.extend({}, Widget.prototype.events, {
        ...
        'click .leave_request': 'action_leave_request',
        'click .leaves_to_approve': 'action_leaves_to_approve',
        'click .leaves_summary': 'action_leaves_summary',
        'click .timesheets_request': 'action_timesheets_request',
        'click .timesheet_verify': 'action_timesheet_verify',
        'click .timesheet_approve': 'action_timesheet_approve',
        ...
        'click .expense_requests': 'action_expense_requests',
        'click .expenses_to_approve': 'action_expenses_to_approve',
        'click .advance_requests': 'action_advance_requests',
        'click .advance_to_approve': 'action_advance_to_approve',
        'click .advance_to_pay': 'action_advance_to_pay',
        'click .expense_to_pay': 'action_expense_to_pay',
    ...
    action_leave_request: function(event) {
        var self = this;
        var user_id = session.uid;
        event.stopPropagation();
        event.preventDefault();
        this.do_action({
            name: _t("Leaves Request"),
            type: 'ir.actions.act_window',
            res_model: 'hr.holidays',
    ...
    action_leaves_summary: function(event) {
        var self = this;
        var user_id = session.uid;
        event.stopPropagation();
        event.preventDefault();
        this.do_action({
            name: _t("Leaves Summary"),
            type: 'ir.actions.act_window',
            res_model: 'hr.holidays',
            ...
            search_view_id: self.employee_data.leave_search_view_id,
            view_id: self.employee_data.leave_summary_view_id,
            target: 'current'
        },{on_reverse_breadcrumb: function(){ return self.reload();}})
    },
    ...
    action_timesheets_request: function(event) {
        var self = this;
        var user_id = session.uid;
        event.stopPropagation();
        event.preventDefault();
        this.do_action({
            name: _t("Timesheets Request"),
            type: 'ir.actions.act_window',
    ...
    action_timesheet_verify : function(event) {
        var self = this;
        var user_id = session.uid;
        event.stopPropagation();
        event.preventDefault();
        this.do_action({
            name: _t("Timesheets Verify"),
            type: 'ir.actions.act_window',
            res_model: 'timesheet.checklist',
            view_mode: 'tree,form',
            view_type: 'form',
            views: [[false, 'list'],[false, 'form']],
            context: {'readonly_by_pass': true},
            domain: [['state', '=', 'manager_approval']],
            search_view_id: self.employee_data.timesheet_search_view_id,
            target: 'current'
        },{on_reverse_breadcrumb: function(){ return self.reload();}})
    },
    action_timesheet_approve: function(event) {
        var self = this;
        var user_id = session.uid;
        event.stopPropagation();
        event.preventDefault();
    ...
    action_expense_requests: function(event) {
        var self = this;
        event.stopPropagation();
        event.preventDefault();
        var user_id = session.uid;
        this.do_action({
            name: _t("Expense Request"),
            type: 'ir.actions.act_window',
            ...
            ['state', '!=', 'cancel']],
            search_view_id: self.employee_data.expense_search_view_id,
            target: 'current'
        },{on_reverse_breadcrumb: function(){ return self.reload();}})
    },
    action_expenses_to_approve: function(event) {
        var self = this;
        event.stopPropagation();
        event.preventDefault();
        this.do_action({
    ...
    action_expense_to_pay: function(event) {
        var self = this;
        event.stopPropagation();
        event.preventDefault();
        this.do_action({
            name: _t("Expense to Pay"),
            type: 'ir.actions.act_window',
            res_model: 'hr.expense.sheet',
            view_mode: 'tree,kanban,form,pivot,graph',
            view_type: 'form',
    ...
    action_advance_requests: function(event) {
        var self = this;
        var user_id = session.uid;
        event.stopPropagation();
        event.preventDefault();
        this.do_action({
            name: _t("Employee Advance Request"),
            type: 'ir.actions.act_window',
            res_model: 'employee.advance',
            view_mode: 'tree,form',
            view_type: 'form',
            views: [[false, 'list'],[false, 'form']],
            context: {'readonly_by_pass': true},
    ...
    action_advance_to_approve: function(event) {
        var self = this;
        event.stopPropagation();
        event.preventDefault();
        this.do_action({
            name: _t("Advance Request to Approve"),
            type: 'ir.actions.act_window',
            res_model: 'employee.advance',
            view_mode: 'tree,form',
            view_type: 'form',
            views: [[false, 'list'],[false, 'form']],
            context: {
                'search_default_pending_manager_approval': true,
                'readonly_by_pass': true},
            target: 'current',
        },{on_reverse_breadcrumb: function(){ return self.reload();}})
    },
    action_advance_to_pay: function(event) {
        var self = this;
        event.stopPropagation();
        event.preventDefault();
        this.do_action({
            name: _t("Advance to Pay"),
            type: 'ir.actions.act_window',
            res_model: 'employee.advance',
            view_mode: 'tree,form',
            view_type: 'form',
